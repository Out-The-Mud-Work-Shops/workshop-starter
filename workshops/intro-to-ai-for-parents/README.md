...
Hands-on is powered by the platform's shared Open WebUI with per-session user
isolation (a per-session proxy injects this session's identity), backed by the
shared Ollama model. No terminal or coding — just chat and guided reading.
